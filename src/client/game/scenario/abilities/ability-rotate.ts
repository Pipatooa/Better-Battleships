...
export class AbilityRotate extends Ability {
     ...
     */
    public static fromSource(abilityRotateSource: IAbilityRotateInfo, shipIndex: number, index: number): AbilityRotate {
        const descriptor = Descriptor.fromSource(abilityRotateSource.descriptor);
        return new AbilityRotate(shipIndex, index, descriptor, abilityRotateSource.rot90, abilityRotateSource.rot180, abilityRotateSource.rot270);
    }
}
