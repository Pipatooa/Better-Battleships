 ...
 * @returns hash Hash to store
 */
export async function hashPassword(password: string): Promise<string> {
    let salt = await bcrypt.genSalt(config.authHashRounds);
 ...
 * @returns boolean Whether password matched hash
 */
 ...
 * @param hash Stored password hash
 * @returns boolean Whether hash needs updating
 */
