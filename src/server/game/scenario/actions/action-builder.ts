...
import { Action, actionSchema, IActionSource } from './action';
 ...
 */
export async function buildAction(parsingContext: ParsingContext, actionSource: IActionSource, checkSchema: boolean): Promise<Action> {
